...
@section('title', 'Unapprove Projects')
...
@endpush
@section('breadcrumb')
<li class="breadcrumb-item active">Unapprove Projects</li>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Unapprove Projects</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body" style="padding: 1.25rem 0.25rem;">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>@hasanyrole('researcher')<a href="{{route('researcher.project.show', $project->id)}}" data-toggle="tooltip" data-placement="top" title="Project Details">{{ $project->title }}</a>@endhasanyrole</td>
