                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control organization" id="organization" name="organization" required>
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('change', '.organization', function() {
            ...
            var url = "{{ url('admin/project/search/member')}}/" + id;
            ...
            $.ajax({
                ...
                var member = $('#member');
                member.empty();
                member.append('<option value="">Select Organization Member</option>')
                for (var i = 0; i < data.members.length; i++) {
                    member.append('<option value=' + data.members[i]['user']['id'] + '>' + data.members[i]['user']['name'] + '</option>')
                }
            });
        });
